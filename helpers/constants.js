...
export const ROLE_PAGES = {
  ...
  staff: ["staff-portal", "profile", "claim-board", "staff-jobs", "completed-jobs"],
  foreman: ["dashboard", "profile", "staff-portal", "foreman-appointments", "claim-board", "jobs", "staff-jobs", "completed-jobs"]
};
